...
# -*- coding: utf-8 -*-
"""
MyPy Type Hints Batch Fix Tool
...
def fix_common_type_hints() -> None:
    ...
    fixes = [
        ...
        (
            ...
            [
                (
                    "def calculate_heat_index(temperature_c: float, humidity: float):",
                    "def calculate_heat_index(temperature_c: float, humidity: float) -> float:",
                ),
                (
                    "def calculate_dew_point(temperature_c: float, humidity: float):",
                    "def calculate_dew_point(temperature_c: float, humidity: float) -> float:",
                ),
                (
                    "def calculate_discomfort_index(temperature_c: float, humidity: float):",
                    "def calculate_discomfort_index(temperature_c: float, humidity: float) -> tuple[float, str]:",
                ),
                ("def main():", "def main() -> None:"),
            ],
        ),
        # quality tools
        (
            "tools/quality/temp/setup_git_hooks.py",
            [
                ("def main():", "def main() -> None:"),
            ],
        ),
        (
            "tools/quality/temp/run_all_checks.py",
            [
                (
