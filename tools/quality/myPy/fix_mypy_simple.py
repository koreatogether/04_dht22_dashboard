...
from pathlib import Path
    ...
    def f""ix_common_function_signatures() -> None:
    ")""자주 사용되는 함수 시그니처 수정"""
 ...
 ") +
     ("               if old_sig in content:
                    conten""t = content.replace(old_sig, new_sig)
                    print(f"))  [TOOL] 수정: {py_file.name} - {old_sig}")
