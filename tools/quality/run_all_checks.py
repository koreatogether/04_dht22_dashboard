...
class AutoTestRunner:
    ...
    def run_phase_tests(self, phase_num: int) -> bool:
        ...
        try:
            ...
            if success:
                print(f"[OK] Phase {phase_num} 테스트 통과")
            else:
                print(f"[ERROR] Phase {phase_num} 테스트 실패")
    ...
    def run_all_quality_checks(self) -> bool:
        ...
        if all_passed:
            print("[OK] 모든 품질 검사 통과")
        else:
            print("[WARNING] 일부 품질 검사 실패")
        return all_passed
