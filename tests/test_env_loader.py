...
from utils.env_loader import (
    EnvLoader, get_str, get_int, get_float, get_bool, get_list,
    load_database_config, load_server_config, load_sensor_config, load_logging_config
)
...
def test_env_loader_with_real_file(temp_env_file):
    ...
    with patch.dict(os.environ, {}, clear=True):
        loader = EnvLoader(temp_env_file)
